...
export const NewArticle2: NewArticleModel[] = [
  {
    id: '3',
    articleImg: '../../../assets/img/fakeImge/new_article_3.png',
    articleTitle: '醫病共享決策的數位轉型與執行管理',
    articleSubtitle: '本研究目的為探討甲狀腺癌術後病人採低碘飲食的持續時間對尿碘濃度之影響。',
    author: '徐珮容',
    authorImg: '../../../assets/img/fakeImge/header_fake_headshot.png',
    viewer: '2021/05/11．1,567',
  ...
  {
    id: '4',
    articleImg: '../../../assets/img/fakeImge/new_article_4.png',
    articleTitle: '早期女性乳癌手術之醫病共享決策',
    articleSubtitle: '傳統的醫療制度中，病人被動的知情同意後接受醫療處置，病人決策參與的程度較低，醫...',
    author: '林欣蓉',
    authorImg: '../../../assets/img/fakeImge/new_article_headshot_1.png',
    viewer: '2021/05/11．1,567',
  },
